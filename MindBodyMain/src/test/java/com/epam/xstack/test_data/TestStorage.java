...
public class TestStorage {
    static public List<User> users = List.of(
            new User(1L, "Alice", "Smith", "alice.smith", "password", true, Role.user),
            new User(2L, "Bob", "Johnson", "bob.johnson", "password", true,Role.user),
            new User(3L, "Charlie", "Brown", "charlie.brown", "password", true,Role.user),

            new User(4L, "Dan", "Taylor", "dan.taylor", "password", true,Role.user),
            new User(5L, "Eva", "White", "eva.white", "password", true,Role.user),
            new User(6L, "Frank", "Miller", "frank.miller", "password", true,Role.user)
    );
